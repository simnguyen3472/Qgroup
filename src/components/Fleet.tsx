...
export default function Fleet() {
  ...
  const fleet = [
    {
      seats: t('fleet.seats_4_7'),
      models: 'Kia Sedona, Toyota Innova...',
      desc: t('fleet.desc_4_7'),
    ...
    {
      seats: t('fleet.seats_16'),
      models: 'Hyundai Solati, Ford Transit',
      desc: t('fleet.desc_16'),
    ...
    {
      seats: t('fleet.seats_29_35'),
      models: 'Thaco, Hyundai',
      desc: t('fleet.desc_29_35'),
    ...
    {
      seats: t('fleet.seats_45'),
      models: 'Universe, Kim Long',
      desc: t('fleet.desc_45'),
    ...
    <section id="fleet" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-sm font-bold text-brand-gold uppercase tracking-widest mb-2">{t('fleet.subtitle')}</h2>
          <h3 className="text-3xl md:text-4xl font-extrabold text-brand-blue uppercase">{t('fleet.title')}</h3>
